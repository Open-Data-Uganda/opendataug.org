  ...
  return (
    <Container>
      <div className="bg-white">
        <header className="  inset-x-0 top-0 z-50 mx-auto">
          <nav
            aria-label="Global"
          ...
          >
            ...
            <div className="hidden items-center gap-4 lg:flex lg:flex-1 lg:justify-end">
              ...
              <Link
                href="/signup"
                className="rounded-lg bg-primary px-4 py-2 text-sm/6 font-semibold text-white transition-colors hover:bg-primary/90"
              >
                Get Started
              </Link>
            </div>
        ...
        <div className="relative isolate px-6 pt-14 lg:px-8">
          ...
          <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
            ...
            <div className="text-center">
              ...
              <div className="mt-10 flex items-center justify-center gap-x-6">
                <a
                  href="#"
                  className="shadow-xs rounded-md bg-primary px-3.5 py-2.5 text-sm font-semibold text-white hover:bg-primary/80 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
                >
                  Read the docs
                </a>
              </div>
          ...
          {/* add a picture of code with API response */}
          <div
            aria-hidden="true"
